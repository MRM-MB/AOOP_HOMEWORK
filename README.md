...
| :--- | :--- | :--- | :--- | :--- |
| **Assignment 1** | [![ImageEditorApp](./Screenshots/Assignment1.webp)](./HW_1/README.md) | Avalonia Application | .NET 9.0 | An application that reads `.b2img.txt` files, loads them into memory, displays and modifies the values using a graphical user interface, and writes the modified data to an output file. |
| **Assignment 2** | [![UniversityManagementApp](./Screenshots/Assignment2.webp)](./HW_2/README.md) | Avalonia Application | .NET 9.0 | An application that manages university-related data, such as students, teachers, and subjects. Features user authentication, data management, and unit testing. |
