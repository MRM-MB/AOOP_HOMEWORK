...
This repository contains **four homework assignments** for the **Object-Oriented Programming (OOP) course - Semester 2**, completed by **Manish Raj Moriche and Luigi Colluto**.  
